...
const EmailGeneration: React.FC = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const suggestedEmail = `${cleanedPrefix}@kwphcda.gov.ng`;
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Create your official KWPHCDA email address
          </p>
        </div>
                ...
                <form onSubmit={handleCreateEmail} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="yourname@kwphcda.gov.ng"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                      required
                    />
                    <p className="mt-1 text-sm text-gray-500">
                      Must end with @kwphcda.gov.ng
                    </p>
                  </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">•</span>
              <span>This service is only available for verified KWPHCDA staff</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">•</span>
