...
import { SignupData, KWARA_LGAS } from '../../types';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="phc_id" className="block text-sm font-medium text-gray-700">
              ...
              {!selectedLGA && (
                <p className="mt-1 text-sm text-gray-500">Please select an LGA first</p>
              )}
            </div>
          </div>
