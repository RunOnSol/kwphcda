    ...
    <div className="space-y-6">
      <div className="prose max-w-none">
        ...
        <p>
          ...
          Kwara State, especially those in rural and underserved communities.
        </p>
        ...
        <div className="bg-green-50 p-6 rounded-lg">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <div className="h-6 w-6 rounded-full bg-green-600 text-white flex items-center justify-center mr-2 flex-shrink-0">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Commitment to high standards in all our operations
                </p>
              </div>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Embracing new ideas and approaches to healthcare delivery
                </p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Empathy and care for all those we serve
                </p>
              </div>
            </li>
          </ul>
        ...
        <div className="bg-green-50 p-6 rounded-lg">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <p className="text-sm">
                Increased immunization coverage from 45% to 85% across the state
              </p>
            </li>
            <li className="flex items-start">
              <div className="h-6 w-6 rounded-full bg-green-600 text-white flex items-center justify-center mr-2 flex-shrink-0">
              ...
              <p className="text-sm">
                Reduced maternal mortality by 30% through improved maternal
                health services
              </p>
            </li>
            <li className="flex items-start">
              ...
              <p className="text-sm">
                Renovated and equipped over 200 primary healthcare centers
                across the state
              </p>
            </li>
            <li className="flex items-start">
              ...
              <p className="text-sm">
                Trained over 1,000 community health workers to expand healthcare
                access
              </p>
            </li>
            <li className="flex items-start">
              ...
              <p className="text-sm">
                Successfully implemented disease surveillance systems in all 16
                LGAs
              </p>
            </li>
          </ul>
